...
export default function ImageToNutrients() {
    ...
    const generateDescription = async () => {
      ...
      Give the OUTPUT in JSON format as shown below:
      {
          ...
          "Fiber": explain in detail the fiber content with units in the food item. Dont create child JSON objects,
          "Cal": Give the calorires with units present in the food item. If multiple items, give total calorie content. Dont create child JSON objects,
                    ...
                    <View>
                        {typeof textOutput === "string" ? (
                            ...
                            <View>
                                ...
                                <Text style={{ fontWeight: 'bold' }}>Macronutrients Present</Text>
                                <View style={styles.descriptionCard}>
                                ...
                                <Text style={{ fontWeight: 'bold' }}>Micronutrients Present</Text>
                                <View style={styles.descriptionCard}>
                                    <Image
                                ...
                                <Text style={{ fontWeight: 'bold' }}>Sustainiblity and Environmental Factors</Text>
                                <View style={styles.descriptionCard}>
                                    <Image
                                        source={require("../assets/supply-chain/dispose.png")}
                                        style={styles.descriptionImage}
                                ...
                                <Text style={{ fontWeight: 'bold' }}>Recommended frequency of Intake</Text>
                                <View style={styles.descriptionCard}>
                                    <Image
                                        source={require("../assets/supply-chain/dispose.png")}
                                        style={styles.descriptionImage}
